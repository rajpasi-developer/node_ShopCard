        ...
        >
            ...
            <div className="w-[100%] h-[100%] flex items-center justify-start">
              ...
              >
                <img
                  ...
                  alt=""
                  className="w-[80%] h-[80%] rounded-lg shodow-2wl hover:border-[#1d1d1d] border-[2px] "
                />
                <input
                  type="file"
                  id="image1"
          ...
          <div className="w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px] ">
            ...
            <input
              ...
              className="w-[600px] max-w[98%] h-[40px] rounded-lg hover:border-[#461f7] border-[2px] cursor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2] "
          ...
          <div className="w-[80%]  flex items-start justify-center flex-col gap-[10px] ">
            ...
            <textarea
              type="text"
              placeholder="Type here"
              className="w-[600px] max-w[98%] h-[100px] py-[10px]  rounded-lg hover:border-[#461f7] border-[2px] cursor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2] "
