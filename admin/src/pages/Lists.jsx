...
const Lists = () => {
  ...
  const removeList = async (id) => {
    try {
      console.log("Sending remove request for ID:", id); // Debug
      ...
      if (result.data) {
        ...
        console.log("Failed to remove Producet");
      }
    } catch (error) {
      console.log(error);
    }
            ...
            list.map((item, index) => (
              ...
              >
                ...
                <div className="w-[90%] h-[80%] flex flex-col items-start justify-center gap-[2px]">
                  ...
                  <div className="w-[17%] md:text-[15px] text-[15px] text-[#bef0f3]">
                    {item.category}
                  </div>
                  <div className="w-[17%] md:text-[15px] text-[15px] text-[#bef0f3]">
                    ₹ {item.price}
                ...
                <div
                  className="w-[10%] h-[100%] bg-transparent
                  flex
                  items-center
                  justify-center
                  "
                >
                  <span
                    className="w-[35px] h-[30%] flex items-center justify-center rounded md:hover:bg-red-300 md:hover:text-black cursor-pointer"
